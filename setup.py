...
dist_name = 'CoupledModeDiscoverer'
package_name = 'CoupledModeDiscoverer'
year = '2024'
url = 'https://github.com/jlandgr/CoupledModeDiscoverer'
...
setup(
    ...
    install_requires=[
        'numpy', 'scipy', 'matplotlib', 'jax', 'networkx'
    ],
